 ...
 */
public class Permissions extends AppCompatActivity implements Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        manageButton.setImageResource(R.drawable.permission);
